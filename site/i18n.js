(() => {
  ...
  const COPY = {
    ...
    zh: {
      ...
      "intro.description": "这份地图整理了近三年有代表性的 DiT 工作，涵盖模型架构、视频与长上下文、高效系统、强化学习、交互式世界模型、具身智能，以及原生统一多模态。收录重点是研究问题和论文之间的联系。",
      "stats.aria": "数据库统计",
      "stats.papers": "篇论文",
      "stats.export": "次导出",
      "stats.exports": "次导出",
