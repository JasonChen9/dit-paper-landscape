(() => {
  ...
  const COPY = {
    en: {
      ...
      "authors.description": "Authors are connected by the topics of their key-author papers; stronger links indicate more similar research profiles. Node size reflects paper count, and color follows each author's dominant topic cluster. Select an author or date range to update the map and paper list together.",
    ...
    zh: {
      ...
      "authors.description": "作者之间的连接来自其关键作者论文的主题相似度，连接越强，研究方向越接近。节点大小表示论文数，颜色对应作者最主要的主题聚类。选择作者或时间区间后，地图与论文列表会同步更新。",
