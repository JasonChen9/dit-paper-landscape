(() => {
  ...
  const COPY = {
    en: {
      ...
      "authors.scope": "Authors include first, explicitly marked co-first, and corresponding authors. Institution follows the primary affiliation on the latest resolved key-author paper.",
      "authors.institutionAria": "Authors by institution",
    ...
    zh: {
      ...
      "authors.scope": "作者范围包含第一作者、论文明确标注的共同第一作者和通讯作者。单位取该作者最新一篇已解析关键作者论文中的主单位。",
      "authors.institutionAria": "按单位统计的作者构成",
